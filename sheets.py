...
def export_to_sheets(data):
    if not data:
        print("⚠️ No hay propiedades nuevas.")
        return
    ...
    try:
        ...
        # 1. LEER LINKS EXISTENTES (Columna I)
        ...
        if not nuevas_filas:
            print("✨ Nada nuevo en esta pasada.")
            return

        # 2. AGREGAR RENGLÓN VACÍO
        ...
        print(f"📊 ¡Éxito! {len(nuevas_filas)-1} agregados.")
